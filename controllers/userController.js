...
const transporter = nodemailer.createTransport({
    service: 'gmail',
    auth: {
        user: 'mangalamab17@gmail.com', // this is the email that will be used to send the email.
        pass: 'rdco wcoo wpos ybcv', //this is the password that is created in app passwords in gmail setting options.
    },
});
